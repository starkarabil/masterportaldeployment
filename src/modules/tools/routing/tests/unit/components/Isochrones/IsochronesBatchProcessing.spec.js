...
describe("src/modules/tools/routing/components/Isochrones/IsochronesBatchProcessing.vue", () => {
    ...
    it("renders IsochronesBatchProcessingComponent", () => {
        wrapper = shallowMount(IsochronesBatchProcessingComponent, {
            store,
            localVue,
            propsData: props
        });
        expect(
            wrapper.findComponent(IsochronesBatchProcessingComponent).exists()
        ).to.be.true;
    });
        ...
        it("should throw error with empty csv", async () => {
            ...
            try {
                ...
                expect(e.message).equal(
                    "modules.tools.routing.isochrones.batchProcessing.errorNoEntries"
                );
            }
        });
...
DEGAC00000007133;13.0285;52.30963`);
                ...
                expect(e.message).equal(
                    "modules.tools.routing.isochrones.batchProcessing.errorToManyEntriesInFile"
                );
            }
        });
...
DEGAC00000007133;13.0285;52.30963;1`);
                ...
                expect(e.message).equal(
                    "modules.tools.routing.isochrones.batchProcessing.errorToManyEntriesInRow"
                );
            }
        });
...
DEGAC00000007133;13.0285;52.30963`);
                ...
                expect(e.message).equal(
                    "modules.tools.routing.isochrones.batchProcessing.errorRowContainsEntriesNoNumber"
                );
            }
        });
    });
