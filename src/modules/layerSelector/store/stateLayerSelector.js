 ...
 * @property {String} source The name of this event. it have to be equal to the source attribute the module sets.|
 ...
 * @property {Boolean} showMenuInDesktopMode If this Event should run in the desktop mode|
 */
const state = {
    events: [],
    default: {
