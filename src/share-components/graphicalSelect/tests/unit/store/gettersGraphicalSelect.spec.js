...
describe("src/share-components/graphicalSelect/store/gettersGraphicalSelect", function () {
    ...
    it("returns the displayName default value from state", function () {
        expect(stateGraphicalSelect.displayName).to.be.equal("snippets.graphicalSelect.displayName");
    });
    ...
    it("returns the tooltipMessage default value from state", function () {
        expect(stateGraphicalSelect.tooltipMessage).to.be.equal("snippets.graphicalSelect.tooltipMessage");
    });
    it("returns the tooltipMessagePolygon default value from state", function () {
        expect(stateGraphicalSelect.tooltipMessagePolygon).to.be.equal("snippets.graphicalSelect.tooltipMessagePolygon");
    });
